...
1. `1. Extract PMID and download papers.ipynb`
2. `2. Llama Inferencing_Vaxjo.ipynb`
3. `3. Output Conversion.ipynb`
4. `4. Mechanism summary and subtype.ipynb`
5. `5. Regroup and plot.ipynb`
6. `6. Regroup Surface and plot.ipynb`
7. `7. Final Adjuvant list and novel.ipynb`
